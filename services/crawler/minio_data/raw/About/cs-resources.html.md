---
doc_id: 'c24638e9d6c6f710'
url: 'https://website.cs.vt.edu/About/cs-resources.html'
title: 'Department technical resources  | Computer Science | Virginia Tech'
crawl_depth: 1
crawl_timestamp: '2026-03-17T02:21:35.675597+00:00'
content_hash: '5011a8b509dce6e9314b71de87da22978018994e1c0e6f800d5b0e509716da70'
---

# Department technical resources
Photo by Peter Means for Virginia Tech.
In addition to the [research systems](http://arc.vt.edu/) available at the university level, the computer science technical staff offers a wide variety of departmental resources to support faculty in their teaching and research activities. Below are just some of the services available to faculty and students.
### Teaching
All instructors have the following resources available to them and their classes:
  ...
  * [Multi-node Linux based cluster](https://wordpress.cs.vt.edu/rlogin/about/) to provide a computational and development environment for instructional classes. 
  * [Containerized environment](http://wiki.cs.vt.edu/wiki/Cloud_Quickstart) where faculty can create and deploy Docker based containers and run them on the department's Kubernetes cluster for instructional purposes.
  ...
  * A dedicated [GitLab repository](https://git.cs.vt.edu/users/sign_in) for instructional purposes.
...
All faculty have the following resources and services available to them and their graduate students for research:
  ...
  * [V](http://csrgpu.cs.vt.edu/)[irtual Machine cluster](http://csrgpu.cs.vt.edu/) with the flexibility to create multi-core large scale VMs.
  * [Virtual GPU Machine cluster](http://csrgpu.cs.vt.edu/) with the flexibility to create multi-core large scale GPU-enabled VMs.
  * The department maintains a dedicated [GitLab repository](https://version.cs.vt.edu/users/sign_in) for research purposes.
...
The department's technical staff provides the following resources and services to faculty for teaching and/or research:
  ...
  * The department provides its own [WordPress instance](https://wordpress.cs.vt.edu/) for teaching and research purposes.
  * A variety of printing services are available, including poster printing for conferences and seminars.
  * The department has access to several site [licensed software packages](https://software.cs.vt.edu/) including most Microsoft products, MatLab, Adobe, and others.
